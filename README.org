...
* Fork reason
Adapt logic to personal requirements. Adds MENU parameter in preamble and logic to pass it through to jekyll in the resulting HTML file.
Here an example:
#+BEGIN_EXAMPLE
#+STARTUP: showall
#+STARTUP: hidestars
#+OPTIONS: H:2 num:nil tags:nil timestamps:t ^:nil toc:nil
# This option removes the table of contents before (!) the jekyll preamble "toc:nil"
# other wise it has to be manually moved after the preamble.
# Removing the toc can help during initial development of the doc page.
#+LAYOUT: page
#+AUTHOR: Foo Bar
#+DATE: 2015-12-16
#+TITLE: Here be a title
#+DESCRIPTION: Details ...
#+CATEGORIES: documenation, stuff, whatever
#+MENU: ROOT/Leaf
#+END_EXAMPLE
